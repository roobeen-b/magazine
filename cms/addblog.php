                  ...
                  <div class="x_content">
                  	...
                  	<form action="process/blog" method="post" enctype="multipart/form-data">
                  		<div class="form-group col-md-8">
                  			...
                  			<input type="text" id="title" class="form-control" name="title" placeholder="Blog Title" value="<?php echo (isset($blog_info->title) && !empty($blog_info->title))?$blog_info->title:"" ?>">
                  		</div>
                  		<div class="form-group col-md-8">
                  		...
                  		<div class="form-group col-md-8">
                  			...
                  			<input type="radio" name="featured" id="featured" value="notFeatured" <?php echo (isset($blog_info->featured) && !empty($blog_info->featured) && $blog_info->featured == 'notFeatured')?"Checked":"" ?>>Non-Featured 
                  		</div>               	
                  		<div class="form-group col-md-8">
                  		...
                  		<?php 
                  		 ...
                  		 ?>
                  		 <div class="form-group col-md-8">
                  		 	<img class="img-responsive" src="<?php echo ($thumbnail) ?>" id="thumbnail" style = "width: 300px; height: auto;">
                  		 </div>
                  		 <div class="form-group col-md-8">
