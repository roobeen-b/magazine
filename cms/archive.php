                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <a href="process/archive?id=<?php echo($archive->id) ?>&amp;act=<?php echo substr(md5("Delete-Archive-".$archive->id.$_SESSION['token']), 3,15) ?>" onclick="return confirm('Are you sure you want to delete this archive?');" class="btn btn-danger">
