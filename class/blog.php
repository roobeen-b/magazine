<?php 
	class blog extends database{
		...
		public function getBlogfromId($blog_id,$is_die=false){
			$args = array(
				'fields' => ['id',
					            'title',
					            'content',
		...
		public function getBlogbyText($text,$is_die=false){
			$args = array(
				'fields' => ['id',
					            'title',
					            'content',
		...
		public function getNumberOfBlogByCategory($cat_id, $is_die=false){
			$args = array(
